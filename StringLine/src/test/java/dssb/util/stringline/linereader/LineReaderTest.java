...
import dssb.util.stringline.linereader.LineReader;
import dssb.util.stringline.linereader.LineReaderBuilder;
import dssb.util.stringline.linereader.NewlineType;
import dssb.util.stringline.linereader.ReadLineTimeoutException;
...
public class LineReaderTest {
	...
	public void timeout_inTime_dontWaitLong() throws IOException, InterruptedException, ReadLineTimeoutException {
		...
		assertEquals("123", inStream.readLine(60000));
	...
	public void timeout_tooLong_doneWithThreeNextReadTimeoutCall()
		...
		long startTime = System.currentTimeMillis();
		assertEquals("8", inStream.readLine(600000));
		assertEquals(null, inStream.readLine());
		long processTime = System.currentTimeMillis() - startTime;
		assertTrue(processTime < 50);
	}
